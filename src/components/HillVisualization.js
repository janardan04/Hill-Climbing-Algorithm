...
const HillVisualization = () => {
  ...
  return (
    <div className="hill-visualization fade-in">
      <canvas ref={canvasRef} className="w-100" style={{ height: "300px" }}></canvas>
      <p className="mt-3 text-center fade-in" style={{ animationDelay: "0.3s" }}>
        This visualization shows how hill climbing moves towards a local maximum. Note that it may get stuck in a local
        optimum instead of finding the global optimum.
      </p>
    </div>
  )
}
